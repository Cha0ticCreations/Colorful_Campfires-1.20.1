...
public class WhiteFireEmberParticles extends TextureSheetParticle {
    protected WhiteFireEmberParticles(ClientLevel pLevel, double pX, double pY, double pZ,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            WhiteFireEmberParticles particle = new WhiteFireEmberParticles(pLevel, pX, pY, pZ, this.sprite, pXSpeed, pYSpeed, pZSpeed);
