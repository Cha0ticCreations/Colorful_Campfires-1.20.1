...
public class BlueFireEmberParticles extends TextureSheetParticle {
    protected BlueFireEmberParticles(ClientLevel pLevel, double pX, double pY, double pZ,
...
//            return lavaparticle;
            BlueFireEmberParticles blueFireEmberParticles = new BlueFireEmberParticles(pLevel, pX, pY, pZ, this.sprite, pXSpeed, pYSpeed, pZSpeed);
...
//            return new BlueFireEmberParticles(pLevel,pX,pY,pZ, this.spriteSet, pXSpeed, pYSpeed, pZSpeed);
//        }
//
//
//    }
