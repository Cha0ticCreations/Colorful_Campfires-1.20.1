...
public class LimeFireEmberParticles extends TextureSheetParticle {
    protected LimeFireEmberParticles(ClientLevel pLevel, double pX, double pY, double pZ,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            LimeFireEmberParticles particle = new LimeFireEmberParticles(pLevel, pX, pY, pZ, this.sprite, pXSpeed, pYSpeed, pZSpeed);
