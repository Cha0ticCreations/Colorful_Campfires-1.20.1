...
public class ModCreativeModeTabs
{
    ...
    public static final RegistryObject<CreativeModeTab> COLORFUL_CAMPFIRES_TAB = CREATIVE_MODE_TABS.register("colorful_campfires_tab",
            ()-> CreativeModeTab.builder().icon(()-> new ItemStack(ModBlocks.BIRCH_CAMPFIRE.get()))
                    .title(Component.translatable("Colorful Campfires: Regular"))
                    .displayItems((pParameters, pOutput)->{

                        // === BASE VARIANTS ===
                        //order is based on vanilla wood order
                        pOutput.accept(ModBlocks.OAK_CAMPFIRE.get());
                        ...
                        // regular (non-dark)
                        pOutput.accept(ModBlocks.WHITE_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_OAK_CAMPFIRE.get());

                        // dark
                        pOutput.accept(ModBlocks.WHITE_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_OAK_DARK_CAMPFIRE.get());
                        ...
                        // DARK OAK CAMPFIRE VARIANTS
                                                // === NON-STRIPPED CAMPFIRES ===
                        // regular (non-dark)
                        pOutput.accept(ModBlocks.WHITE_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_DARK_OAK_CAMPFIRE.get());

                        // dark
                        pOutput.accept(ModBlocks.WHITE_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_DARK_OAK_DARK_CAMPFIRE.get());
                        ...
                        // === NON-STRIPPED CAMPFIRES ===
                        // regular (non-dark)
                        pOutput.accept(ModBlocks.WHITE_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_CHERRY_CAMPFIRE.get());

                        // dark
                        pOutput.accept(ModBlocks.WHITE_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_CHERRY_DARK_CAMPFIRE.get());
    ...
    public static final RegistryObject<CreativeModeTab> STRIPPED_CAMPFIRES_TAB = CREATIVE_MODE_TABS.register("stripped_campfires_tab",
            ()-> CreativeModeTab.builder().icon(()-> new ItemStack(ModBlocks.STRIPPED_BIRCH_CAMPFIRE.get()))
                    .title(Component.translatable("Colorful Campfires: Stripped"))
                    .displayItems((pParameters, pOutput)->{

                        // === BASE STRIPPED VARIANTS ===
                        //order is based on vanilla wood order
                        pOutput.accept(ModBlocks.STRIPPED_OAK_CAMPFIRE.get());
                        ...
                        pOutput.accept(ModBlocks.STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.STRIPPED_MANGROVE_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.STRIPPED_CRIMSON_STEM_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.STRIPPED_WARPED_STEM_CAMPFIRE.get());

                        // STRIPPED OAK CAMPFIRE VARIANTS
                        // regular (non-dark)
                        pOutput.accept(ModBlocks.WHITE_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_STRIPPED_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_STRIPPED_OAK_CAMPFIRE.get());

                        // dark
                        pOutput.accept(ModBlocks.WHITE_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_STRIPPED_OAK_DARK_CAMPFIRE.get());
                        ...
                        // DARK OAK CAMPFIRE VARIANTS
                        // STRIPPED DARK_OAK CAMPFIRE VARIANTS
                        // regular (non-dark)
                        pOutput.accept(ModBlocks.WHITE_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_STRIPPED_DARK_OAK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_STRIPPED_DARK_OAK_CAMPFIRE.get());

                        // dark
                        pOutput.accept(ModBlocks.WHITE_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_STRIPPED_DARK_OAK_DARK_CAMPFIRE.get());
                        ...
                        // STRIPPED CHERRY CAMPFIRE VARIANTS
                        // regular (non-dark)
                        pOutput.accept(ModBlocks.WHITE_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_STRIPPED_CHERRY_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_STRIPPED_CHERRY_CAMPFIRE.get());

                        // dark
                        pOutput.accept(ModBlocks.WHITE_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_GRAY_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GRAY_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLACK_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BROWN_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.RED_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.ORANGE_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.YELLOW_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIME_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.GREEN_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.CYAN_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.LIGHT_BLUE_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.BLUE_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PURPLE_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.MAGENTA_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
                        pOutput.accept(ModBlocks.PINK_STRIPPED_CHERRY_DARK_CAMPFIRE.get());
