...
public class ModEventBusClientEvents {
    ...
    public static void registerBER(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // OAK CAMPFIRE VARIANTS
        // === BLACK VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === BLUE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
       
        // === BROWN VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === CYAN VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === GRAY VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
       
        // === GREEN VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === LIGHT BLUE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === LIGHT GRAY VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === LIME VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === MAGENTA VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === ORANGE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === PINK VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === PURPLE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === RED VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.RED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.RED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.RED_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.RED_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === WHITE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === YELLOW VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_STRIPPED_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_STRIPPED_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        ...
        // === BLACK VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLACK_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === BLUE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BLUE_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
       
        // === BROWN VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.BROWN_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === CYAN VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.CYAN_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === GRAY VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GRAY_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
       
        // === GREEN VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.GREEN_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === LIGHT BLUE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_BLUE_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === LIGHT GRAY VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIGHT_GRAY_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === LIME VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.LIME_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === MAGENTA VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.MAGENTA_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === ORANGE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.ORANGE_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === PINK VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PINK_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === PURPLE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.PURPLE_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === RED VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.RED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.RED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.RED_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.RED_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === WHITE VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.WHITE_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);

        // === YELLOW VARIANTS ===
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_STRIPPED_DARK_OAK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.YELLOW_STRIPPED_DARK_OAK_DARK_CAMPFIRE_BE.get(), UniversalCampfireBlockRenderer::new);
